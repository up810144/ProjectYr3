...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_D_C2'
...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C2_SLAQ'
...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_SLAQ_C3'
...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C3_LRG'
...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_LRG_C5'
...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C5_C6'
...
directory = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C6_D'
...
vdisp2=[1.95,2.05,2.25,2.35,2.45] #needed as not all have bins have arrays for all vdisp
vdisp3=[2.15,2.25,2.35,2.45]
...
plt.plot(vdisp3,Z_5,c='gold',label='LRG-C5')
plt.plot(vdisp2,Z_6,c='orange',label='C5-C6')
plt.plot(vdisp3,Z_7,c='red',label='C6-D')
