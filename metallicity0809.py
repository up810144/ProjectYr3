...
Z_1_low_err=[]
for i in range(6):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_D_C2/spFly-z0809_CBDC2_V'+N[i]+'_DAP.fits'
...
Z_2_low_err=[]
for i in range(6):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C2_SLAQ/spFly-z0809_CBC2SLAQ_V'+N[i]+'_DAP.fits'
	hdu = fits.open(filename)
	metallicity = hdu[1].header['metallicity_lightW'] #Z/H
	age = hdu[1].header['age_lightW'] #log(age/Gyr)
...
Z_3_low_err=[]
for i in range(6):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_SLAQ_C3/spFly-z0809_CBSLAQC3_V'+N[i]+'_DAP.fits'
	hdu = fits.open(filename)
	metallicity = hdu[1].header['metallicity_lightW'] #Z/H
	age = hdu[1].header['age_lightW'] #log(age/Gyr)
...
Z_4_low_err=[]
for i in range(6):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C3_LRG/spFly-z0809_CBC3LRG_V'+N[i]+'_DAP.fits'
	hdu = fits.open(filename)
	metallicity = hdu[1].header['metallicity_lightW'] #Z/H
	age = hdu[1].header['age_lightW'] #log(age/Gyr)
...
Z_5_low_err=[]
for i in range(4):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_LRG_C5/spFly-z0809_CBLRGC5_V'+N_2[i]+'_DAP.fits'
	hdu = fits.open(filename)
	metallicity = hdu[1].header['metallicity_lightW'] #Z/H
	age = hdu[1].header['age_lightW'] #log(age/Gyr)
...
#initial arrays
N_3=['1','2','4','5','6']
vdisp3=[1.95,2.05,2.25,2.35,2.45]
chi_arr_6 = []
Z_6 = []
logAge_6 = []
Z_6_up_err=[]
Z_6_low_err=[]
for i in range(5):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.7_0.8/CB_C5_C6/spFly-z0708_CBC5C6_V'+N_3[i]+'_DAP.fits'
	hdu = fits.open(filename)
	metallicity = hdu[1].header['metallicity_lightW'] #Z/H
	age = hdu[1].header['age_lightW'] #log(age/Gyr)
...
Z_7_low_err=[]
for i in range(4):
	filename = '/users/zak/Documents/output/FireFly_eBOSS/z_0.8_0.9/CB_C6_D/spFly-z0809_CBC6D_V'+N_2[i]+'_DAP.fits'
	hdu = fits.open(filename)
	metallicity = hdu[1].header['metallicity_lightW'] #Z/H
	age = hdu[1].header['age_lightW'] #log(age/Gyr)
...
plt.errorbar(vdisp2,Z_5,yerr=[Z_5_low_err,Z_5_up_err],fmt='o',elinewidth=0.9,capsize=2,color='gold',label='LRG-C5')
plt.errorbar(vdisp3,Z_6,yerr=[Z_6_low_err,Z_6_up_err],fmt='o',elinewidth=0.9,capsize=2,color='orange',label='C5-C6')
plt.errorbar(vdisp2,Z_7,yerr=[Z_7_low_err,Z_7_up_err],fmt='o',elinewidth=0.9,capsize=2,color='red',label='C6-D')
